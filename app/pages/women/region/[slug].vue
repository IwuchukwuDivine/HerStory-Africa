<template>
  <div class="hub">
    <nav class="hub__crumbs" aria-label="Breadcrumb">
      ...
      <span class="hub__crumb">By region</span>
    </nav>
    ...
    <footer class="hub__footer">
      <div class="hub__siblings">
        <h2 class="hub__siblings-title">Other regions</h2>
        <ul class="hub__sibling-list">
          <li v-for="r in otherRegions" :key="r">
      ...
      <div class="hub__siblings">
        <h2 class="hub__siblings-title">Browse by era</h2>
        <ul class="hub__sibling-list">
          <li v-for="e in ERAS" :key="e">
